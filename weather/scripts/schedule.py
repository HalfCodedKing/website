...
NOAA15_passes = NOAA15_predictor.passes_over(location=loc, when_utc=datetime.utcnow(), limit_date=date.today() + timedelta(days=1), max_elevation_gt=20)
...
NOAA18_passes = NOAA18_predictor.passes_over(location=loc, when_utc=datetime.utcnow(), limit_date=date.today() + timedelta(days=1), max_elevation_gt=20)
...
NOAA19_passes = NOAA19_predictor.passes_over(location=loc, when_utc=datetime.utcnow(), limit_date=date.today() + timedelta(days=1), max_elevation_gt=20)
